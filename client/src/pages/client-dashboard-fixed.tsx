                      ...
                      <Form {...wellForm}>
                        <form onSubmit={wellForm.handleSubmit(handleWellSubmit)} className="space-y-4">
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Textarea placeholder="Observações sobre o poço" {...field} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <div className="flex justify-end gap-2 pt-4">
                            <Button type="button" variant="outline" onClick={() => setIsWellDialogOpen(false)}>
                              Cancelar
                            </Button>
                            <Button type="submit" disabled={createWellMutation.isPending}>
