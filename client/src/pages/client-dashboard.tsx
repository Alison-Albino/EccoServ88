...
import { Droplet, CheckCircle, Clock, Search, Calendar, Wrench, MapPin, Camera, AlertCircle } from "lucide-react";
import { useQuery } from "@tanstack/react-query";
import { type VisitWithDetails, type ScheduledVisitWithDetails } from "@shared/schema";
          ...
          <TabsContent value="wells">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              <div className="p-6 border-b border-gray-200">
                <h2 className="text-xl font-semibold text-gray-900">Meus Poços Ativos</h2>
              </div>
